<template>
  <div class="top-notch-container">
    <h2>How We Do It</h2>
    <p>Use our simple three-step application development process to expedite the completion of your project.</p>
    <div class="mid-count">
        <div class="one">1</div>
      ...
      <div class="mid-model">
        <div class="text-area">
          <ul class="menu-side">
            ...
            <li class="menu-item-side">Documenting the process</li>
