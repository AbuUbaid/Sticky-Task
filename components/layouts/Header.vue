<template>
  <div class="main-header">
    ...
    <div
      id="industries-menu"
      class="mega-menu"
      v-bind:class="{ open: industryOpen }"
    >
      <ul class="menu-side">
        <li class="menu-item-side">
    ...
    <div
      id="solutions-menu"
      class="mega-menu"
      v-bind:class="{ open: solutionOpen }"
    >
      <ul class="menu-side">
        <li class="menu-item-side">
    ...
    >
      <div class="menu-container">
        <ul class="menu">
          <li class="menu-item sub-menu-item services">
...
})(window,document,'script','dataLayer','GTM-WJSV6KD');</script>
